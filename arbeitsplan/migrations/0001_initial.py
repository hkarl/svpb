    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='OF', max_length=2, choices=[('OF', 'Offen'), ('AK', 'Akzeptiert'), ('RU', 'R\xc3\xbcckfrage'), ('NE', 'Abgelehnt')])),
                ('bemerkung', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefMitglied', models.IntegerField(default=1, help_text='Haben Sie Vorlieben f\xc3\xbcr diese Aufgabe?', choices=[(-1, 'Nein'), (0, 'Wenn es sein muss'), (1, 'Ok'), (2, 'Gerne!')])),
                ('prefVorstand', models.IntegerField(default=1, help_text='Trauen Sie diesem Mitglied die Aufgabe zu?', choices=[(-1, 'Nein'), (0, 'Wenn es sein muss'), (1, 'Ok'), (2, 'Gerne!')])),
                ('bemerkung', models.TextField(blank=True)),
